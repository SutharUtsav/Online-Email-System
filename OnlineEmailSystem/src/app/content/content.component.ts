...
export class ContentComponent implements OnInit {
  ...
  constructor(private location :Location,private router:Router,private ar:ActivatedRoute,private mail:MailServiceService) {
   }
  ...
  Forward(id:number){
    this.router.navigate(['main/forward',id]);
  }
